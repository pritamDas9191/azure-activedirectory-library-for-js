                            ...
                            if (requestInfo.requestType === _adal.REQUEST_TYPE.RENEW_TOKEN) {
                                ...
                                if (callback && typeof callback === 'function') {
                                    ...
                                    if (requestInfo.parameters['access_token']) {
                                        ...
                                        _adal.verbose("$broadcast, adal:tokenRenewalFailure " + _adal._getItem(_adal.CONSTANTS.STORAGE.ERROR_DESCRIPTION));
                                        $rootScope.$broadcast('adal:tokenRenewalFailure', _adal._getItem(_adal.CONSTANTS.STORAGE.ERROR_DESCRIPTION));
                                        return;
                                    }
                                }
