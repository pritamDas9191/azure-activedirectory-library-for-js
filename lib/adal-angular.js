                        ...
                        if (requestInfo.stateMatch) {
                            ...
                            if (requestInfo.requestType === _adal.REQUEST_TYPE.RENEW_TOKEN) {
                                ...
                                if (callback && typeof callback === 'function') {
                                    ...
                                    var error = _adal._getItem(_adal.CONSTANTS.STORAGE.ERROR) || requestInfo.parameters['error'];
                                    var errorDescription = _adal._getItem(_adal.CONSTANTS.STORAGE.ERROR_DESCRIPTION) || requestInfo.parameters['error_description'];
                                    if ($window.parent === $window && !$window.parent.callBackMappedToRenewStates[requestInfo.stateResponse]) {
                                        if (token) {
                                            if (token == requestInfo.parameters['access_token']) {
