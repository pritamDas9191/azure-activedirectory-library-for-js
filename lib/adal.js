...
var AuthenticationContext = (function () {
      ...
      */
        ...
        AuthenticationContext.prototype._supportsLocalStorage = function () {
            ...
            try {
                if (!('localStorage' in window && window['localStorage'])) return false; // Test availability
        ...
        AuthenticationContext.prototype._supportsSessionStorage = function () {
            ...
            try {
                if (!('sessionStorage' in window && window['sessionStorage'])) return false; // Test availability
